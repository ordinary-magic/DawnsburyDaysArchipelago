...
* Any pending traps or boons will trigger automatically at the start of your turn (at most one per turn).
...
* In hardcore mode, if you lose an encounter, the campaign will re-randomize, and you will be forced to start over at the first mission. You will not send new checks until you make it back to where you lost. 
...
* You can avoid the hardcore mode reset by clicking "Retry Encounter" and winning. Fixing this is difficult, and players can simply choose not to do this.
